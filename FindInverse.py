...
def find_augmented_matrix(matrix: SimpleMatrix) -> SimpleMatrix:
    """
    Finds the augmented matrix consisting of the matrix and the corresponding identity matrix if it is invertible.
    It is invertible if it is square and non-singular.
